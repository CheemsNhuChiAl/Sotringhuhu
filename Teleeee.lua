...
local Window = OrionLib:MakeWindow({Name = "Strawberry Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Strawberry hub"})
...
Notify("Welcome To Strawberry Hub",5)
Notify("Thank for use Script Me!!:)",5)
Notify("Version 1.35",5)
...
local SV = Window:MakeTab({
	Name = "Status & Servers",
	Icon = "rbxassetid://10723364725",
	PremiumOnly = false
})

local R = Window:MakeTab({
	Name = "Fully Raid",
	Icon = "rbxassetid://10709761722",
	PremiumOnly = false
})
...
local LC = Window:MakeTab({
	Name = "Local Players",
	Icon = "rbxassetid://15712750195",
	PremiumOnly = false
})

local SH = Window:MakeTab({
	Name = "Shop",
	Icon = "rbxassetid://14477621526",
	PremiumOnly = false
})
...
I:AddLabel("Owner: CheemsBeo")

I:AddLabel("CheemsBeoo ")
I:AddLabel("Version : 1.35")

I:AddLabel("NgayGiThe?")
I:AddLabel("Status : Bình Thường mà?")
I:AddLabel("Update Log Ui Orion!!")
...
local ModeList = {"Farm Level","Farm Bone","Farm Dought Boss"}
G:AddDropdown({
...
KI:AddParagraph("Lưu ý","Vie :  Khi Bật Collect Azure Lưu ý bạn phải ở Kitsune Island. Nếu chưa! Hãy bật Teleport To Kitsune Island chờ nó đến rồi bật.")
...
Notify("Loading Config and Functions Completedd!!!!!!!!!", 5)